                        ...
                        <div class="options-overlay rounded-lg bg-white-50">
                            <div class="options-overlay-content">
                                <div class="mb-3">
                                    ...
                                    <a class="btn btn-hero-light" data-toggle="tooltip" title="Ver Documento" onClick="this.href='{{ URL::to('https://teleconsulta.gobeltech.com/visor/dicomPaciente').'/'.$value->id}}" target="_blank">
                                        <i class="fa fa-eye text-primary mr-1"></i> Ver Imagen Dicom
                                    </a>                                  
                                </div>
                                <div class="btn-group">
