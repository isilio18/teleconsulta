...
<div class="content content-full content-boxed">
    ...
    <!-- New Post -->
    <form action="{{ URL::to('proceso/documento/guardar') }}" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <input type="hidden" name="solicitud" value="{{ $id }}">
        <input type="hidden" name="ruta" value="{{ $ruta }}">
        <input type="hidden" name="in_dicom" value="1">
        <div class="block">
            <div class="block-header block-header-default">
                <a class="btn btn-light" href="{{ URL::to('proceso/documento/listaDicom'). '/'. $id }}">
                        ...
                        <div class="form-group row">
                            <div class="col-xl-12">
                                ...
                                <div class="custom-file">
                                    ...
                                    <input multiple="" type="file" class="custom-file-input {!! $errors->has('archivo') ? 'is-invalid' : '' !!}" id="archivo" name="archivo[]" data-toggle="custom-file-input" {{ $errors->has('archivo') ? 'aria-describedby="archivo-error" aria-invalid="true"' : '' }}>
                                    <label for="archivo" class="custom-file-label">Seleccione Documento...</label>
