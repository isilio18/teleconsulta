...
<div class="content content-full content-boxed">
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Culminadas</li>
                </ol>
            </nav>
        </div>                  
        ...
        <form action="{{ url('/proceso/solicitud/completo') }}" method="get">
            <div class="row">
                ...
                @foreach($tab_solicitud as $key => $value)
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Detalle" onclick="location.href='{{ url('/proceso/ruta/lista/ver').'/'. $value->id }}'">
